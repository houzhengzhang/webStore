...
<HTML>
    ...
    <body>
        ...
        <form id="userAction_save_do" name="Form1"
              action="${pageContext.request.contextPath}/AdminProductServlet?method=editProduct" method="post"
            ...
            <table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee"
                ...
                <tr>
                    ...
                    <td class="ta_01" bgColor="#ffffff">
                        <input type="text" name="pname" value="${product.pname}" id="userAction_save_do_logonName"
                               class="bg"/>
                    </td>
                    <td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
                        是否热门：
                    ...
                    <td class="ta_01" bgColor="#ffffff" colspan="3">
                        <select name="cid">
                            ...
                            <c:forEach items="${allCats}" var="c">
                                <option value="${c.cid}"
                                        <c:if test="${c.cid == product.cid}">selected="selected"</c:if> > ${c.cname}
                                </option>
                            </c:forEach>
                        </select>
                    </td>
