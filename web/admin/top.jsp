                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        ...
                                        <td width="155" valign="bottom"
                                            ...
                                            &nbsp;&nbsp;| &nbsp;<a style="color: #1E6BAE" target="_top" href="${pageContext.request.contextPath}/AdminServlet?method=logOut">退出</a>
                                        </td>
                                        <td width="10" align="right"
                                            background="${pageContext.request.contextPath}/img/admin/mis_05b.jpg">
                                            <img src="${pageContext.request.contextPath}/img/admin/mis_05c.jpg"
                                                 width="6" height="18">
                                        </td>
                                    </tr>
                                </table>
