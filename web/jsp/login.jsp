...
<html>
    ...
    <body>
        ...
        <div class="container"
             style="width:1130px;height:460px;background:white url('${pageContext.request.contextPath}/img/loginbg.png') no-repeat;">
            <div class="row">
                <div class="col-md-7">
                </div>
                        ...
                        <form class="form-horizontal"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <img src="${pageContext.request.contextPath}/ValidateCodeServlet?method=getValidateCode"
                                         id="verifyImg" onclick="changeImg()"/>
                                </div>
        ...
        <script type="text/javascript">
            ...
            function changeImg() {
                ...
                img.src = "${pageContext.request.contextPath}/ValidateCodeServlet?method=getValidateCode&date="
                    + new Date();
            }
